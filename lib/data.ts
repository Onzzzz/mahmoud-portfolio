...
export const projects = [
  {
    ...
    description: "Delivered AED 450,000+ in documented savings on one engagement through strategic sourcing, supplier negotiation, and specification optimization — the largest single-project saving in the company's procurement history.",
    highlights: [
      "AED 450,000+ documented savings on a single project",
      "Renegotiated supplier contracts and identified alternative sources",
      "Established the benchmark for procurement savings reporting across the company",
    ],
    tools: ["Strategic Sourcing", "Negotiation", "Cost Analysis", "Vendor Management"],
    featured: true,
  },
  {
    ...
    description: "Led end-to-end procurement for 30+ major events — COP28, FIFA World Cup, GITEX, Esports World Cup, Elie Saab (Celine Dion & J-Lo), Art Dubai, and World Defense Show. Managed budgets up to AED 10M per event.",
    highlights: [
      "10-20% cost reduction consistently across all engagements",
      "100+ qualified vendors across UAE, KSA, Europe & Asia",
      "Zero project delays due to procurement — 100% on-time delivery record",
    ],
    tools: ["Tejari", "Contract Management", "Multi-country Sourcing", "Budget Control"],
    featured: true,
  },
  {
    ...
    description: "Self-implementing Odoo 18 Enterprise SaaS across procurement, inventory, sales, and operations — from gap analysis to module configuration to user training, without external consultants.",
    highlights: [
      "Configured procurement, inventory, sales, and operations modules",
      "Designed workflows matching actual business processes",
      "Created a 23-chapter implementation guide and 11-phase operations portal",
    ],
    tools: ["Odoo 18", "ERP Configuration", "Process Mapping", "Change Management"],
    featured: false,
  },
  {
    ...
    company: "Golden Sparrow Trading",
    category: "Procurement & Tenders" as const,
    description: "Built the entire procurement and tendering function from scratch for a heavy equipment trading company — structure, SOPs, approval matrices, supplier portals, and compliance governance across UAE, KSA, and Oman.",
    highlights: [
      "Created all SOPs, policies (ESG, Anti-Bribery, HSE), and governance documentation",
      "Registered across government and private portals in 3 countries",
      "Designed a 4-layer legal framework for installment sales with title retention",
    ],
    tools: ["Policy Writing", "Portal Management", "Legal Frameworks", "Compliance"],
    featured: false,
  },
] as const;
